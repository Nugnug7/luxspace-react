          ...
          <section className="container mx-auto">
            <div className="flex flex-wrap my-4 md:my-12">
                    ...
                    <div className="flex-1">
                        <div className="slider flex flex-row space-x-4">
                            <div className="thumbnails flex flex-col space-y-4 overflow-y-auto max-h-[500px] w-60">
                                ...
                                <div className="px-2">
                                    <div
                                    className="item"
                                    data-img="/images/contents/showcase-1.back.jpg"
                                    >
                                    <img
                                        src="/images/contents/showcase-1.back.jpg"
                                        alt="back"
                                        className="object-cover w-full h-full rounded-lg"
                                    />
                                    </div>
                                ...
                                <div className="px-2">
                                    <div
                                    className="item"
                                    data-img="/images/contents/showcase-1.rear.jpg"
                                    >
                                    <img
                                        src="/images/contents/showcase-1.rear.jpg"
                                        alt="rear"
                                        className="object-cover w-full h-full rounded-lg"
                                    />
                                    </div>
                                ...
                                <div className="px-2">
                                    <div
                                    className="item"
                                    data-img="/images/contents/showcase-1.side.jpg"
                                    >
                                    <img
                                        src="/images/contents/showcase-1.side.jpg"
                                        alt="side"
                                        className="object-cover w-full h-full rounded-lg"
                                    />
                                    </div>
                                ...
                                <div className="px-2">
                                    <div
                                    className="item"
                                    data-img="/images/contents/showcase-1.top.jpg"
                                    >
                                    <img
                                        src="/images/contents/showcase-1.top.jpg"
                                        alt="top"
                                        className="object-cover w-full h-full rounded-lg"
                                    />
                                    </div>
                            ...
                            <div className="preview">
                                <div className="item rounded-lg h-[500px] h-full overflow-hidden">
                                    <img
                                    src="/images/contents/showcase-1.front.jpg"
                                    alt="front"
                                    className="object-cover w-full h-full rounded-lg"
