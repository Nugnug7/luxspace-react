            ...
            <div className="thumbnail">
              <div className="px-2">
                <div
                  ...
                  data-img="/images/contents/showcase-1.front.png">
                  <img
                    src="/images/contents/showcase-1.front.png"
                    alt="front"
              ...
              <div className="px-2">
                <div
                  className="item"
                  data-img="/images/contents/showcase-1.back.png"
                >
                  <img
                    src="/images/contents/showcase-1.back.png"
                    alt="back"
                    className="object-cover w-full h-full rounded-lg"
                  />
                </div>
