                ...
                <div className="overflow-x-hidden px-4" id="carousel">
                    ...
                    <div className="px-4 relative card group">
                     ...
                     className="rounded-xl overflow-hidden card-shadow relative"
                        ...
                        <img
                            src="./images/contents/image-arrived-1.png"
                            alt=""
                    ...
                    <div className="px-4 relative card group">
                     ...
                     className="rounded-xl overflow-hidden card-shadow relative"
                        ...
                        <img
                            src="./images/contents/image-arrived-2.png"
                            alt=""
                         className="w-full h-full object-cover object-center"
                        />
                        </div>
                    ...
                    <div className="px-4 relative card group">
                     ...
                     className="rounded-xl overflow-hidden card-shadow relative"
                        ...
                        <img
                            src="./images/contents/image-arrived-3.png"
                            alt=""
                         className="w-full h-full object-cover object-center"
                        />
                        </div>
                    ...
                    <div className="px-4 relative card group">
                     ...
                     className="rounded-xl overflow-hidden card-shadow relative"
                        ...
                        <img
                            src="./images/contents/image-arrived-4.png"
                            alt=""
                         className="w-full h-full object-cover object-center"
                        />
                        </div>
                    ...
                    <div className="px-4 relative card group">
                     ...
                     className="rounded-xl overflow-hidden card-shadow relative"
                        ...
                        <img
                            src="./images/contents/image-arrived-5.png"
                            alt=""
                         className="w-full h-full object-cover object-center"
                        />
                        </div>
