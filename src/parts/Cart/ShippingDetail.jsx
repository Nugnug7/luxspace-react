                ...
                <div className="flex flex-col mb-4">
                  ...
                  <div className="flex -mx-2 flex-wrap">
                    <div className="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/images/contents/logo-fedex.svg"
                          alt="Logo Fedex"
                    ...
                    <div className="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/images/contents/logo-dhl.svg"
                          alt="Logo dhl"
                          className="object-contain max-h-full"
                        />
                      </button>
                ...
                <div className="flex flex-col mb-4">
                  ...
                  <div className="flex -mx-2 flex-wrap">
                    <div className="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/images/contents/logo-midtrans.png"
                          alt="Logo midtrans"
                          className="object-contain max-h-full"
                        />
                      </button>
                    ...
                    <div className="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/images/contents/logo-mastercard.svg"
                          alt="Logo mastercard"
                        />
                      </button>
                    </div>
                    <div className="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/images/contents/logo-bitcoin.svg"
                          alt="Logo bitcoin"
                          className="object-contain max-h-full"
                        />
                      </button>
                    ...
                    <div className="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/images/contents/logo-american-express.svg"
